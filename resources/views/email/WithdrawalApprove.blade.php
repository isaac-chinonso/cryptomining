...
<body paddingwidth="0" paddingheight="0" class='bgBody' style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableContent" align="center" bgcolor="#EAEAEA" style='font-family:helvetica, sans-serif;'>
        <!-- ================ header=============== -->
        <tbody>
            <tr style="font-size: 14px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            <p style="font-size: 17px;">
                                                                                Dear {{ $withdraw->user->profile->first()->fname }} {{ $withdraw->user->profile->first()->lname }} ,<br>

                                                                                Your withdrawal of ${{ number_format($withdraw->amount, 0, '.', ', ') }} has been approved and sent to your {{ $withdraw->payment_type }} account <br>
                                                                                {{ $withdraw->wallet }}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <tr style="font-size: 14px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                                                                <td class="esd-block-text es-p20t" align="center">
                                                                    <h3 style="color: #333333;">Thank you, british capital raise</h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                            ...
                                                                            <tr style="font-size: 14px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                                                                                <td class="esd-block-text es-m-txt-c es-p5b" esdev-links-color="#777777" align="left">
                                                                                    <p style="color: #777777;"> © 2023
                                                                                        british capital raise <br> You are receiving
                                                                                        this email because you signed up
                                                                                        on <a href="britishcapitalraise.com" style="color:#aaaaaa">britishcapitalraise.com</a>. .<br></p>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
