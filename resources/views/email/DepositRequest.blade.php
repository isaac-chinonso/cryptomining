                                                                    ...
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            <p style="font-size: 17px;">
                                                                                Dear {{ $deposit->user->profile->first()->fname }} {{ $deposit->user->profile->first()->lname }} ,<br>

                                                                                You Made a Deposit of ${{ number_format($deposit->amount, 0, '.', ', ') }} {{ $deposit->payment_type }}, you will get an email once confirmed. <br>
